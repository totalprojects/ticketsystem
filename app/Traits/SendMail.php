            ...
            case 3:
                        ...
                        $templateHTML_1 = [];
                            ...
                            if($template) {
                                ...
                                $module_id = $requested->modules->name;
                                $tcode_id = $requested->tcodes->t_code;
                                $sap_lead = Moderators::where('type_id',1)->with('employee')->first();
                    ...
                    case 4:
                        ...
                        $templateHTML_1 = [];
                            ...
                            if($template) {
                                ...
                                $module_id = $requested->modules->name;
                                $tcode_id = $requested->tcodes->t_code;
                                $sap_lead = Moderators::where('type_id',2)->with('employee')->first();
                                $user_id = $sap_lead->employee->first_name;
                                $actions = '';
                                foreach($requested->action as $ea) {
                                    $actions .= $ea->name.',';
                ...
                case 5:
                    ...
                    $template = \MailTemplates::where(['type_id' => $approval_type, 'approval_matrix_id' => 5])->first();
                        ...
                        if($template) {
                            ...
                            $module_id = $requested->modules->name;
                            $tcode_id = $requested->tcodes->t_code;
                            $sap_lead = Moderators::where('type_id',3)->with('employee')->first();
                            $user_id = $sap_lead->employee->first_name;
                            $actions = '';
                            foreach($requested->action as $ea) {
                                $actions .= $ea->name.',';
                ...
                case 6:
                    ...
                    $template = \MailTemplates::where(['type_id' => $approval_type, 'approval_matrix_id' => 6])->first();
                        ...
                        if($template) {
                            ...
                            $module_id = $requested->modules->name;
                            $tcode_id = $requested->tcodes->t_code;
                            $sap_lead = Moderators::where('type_id',4)->with('employee')->first();
                            $user_id = $sap_lead->employee->first_name;
                            $actions = '';
                            foreach($requested->action as $ea) {
                                $actions .= $ea->name.',';
