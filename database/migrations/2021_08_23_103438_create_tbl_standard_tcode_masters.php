...
class CreateTblStandardTcodeMasters extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
     */
    public function up() {
        Schema::create('tbl_standard_tcode_masters', function (Blueprint $table) {
            $table->id();
    ...
    public function down() {
        Schema::dropIfExists('tbl_standard_tcode_masters');
    }
}
