...
<style>
    .dx-treelist-container {
        ...
        /*  box-shadow:0 0 2px 2px rgba(0,0,0,0.75); */
    }
...
function fetch_data(){
   ...
   var url = "{{ route('get.menu.list') }}"
           $.ajax({
               ...
               error: function () {
                   toastr.error("Data Loading Error");
               },
...
function loadTree(data) {
    const treeList = $('#menu-list-div').dxTreeList({
    dataSource: data,
    rootValue: 0,
...
//       e.rowElement.find("td").css('background', '#fff2a8');
