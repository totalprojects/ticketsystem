...
<div class="tab-content p-1">
    <div class="tab-pane active dx-viewport" id="users">
        <div class="demo-container">
          <div class="top-info">
            <div class="table-heading-custom"><h4 class="right"><i class="fas fa-building"></i> PO Group List </h4></div>
            <button id="add_btn" class='custom-theme-btn'><i class='fa fa-plus'></i> PO Group</button>
          </div>
    ...
    <div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Add PO Group</h5>
                ...
                <form id="add-frm" method="post">
                    <div class="row">
                        <div class="col-lg-4 pt-2">
                            <input type="text" name="pg_description" id="pg_description" class="form-control" placeholder="Enter Description">
                        </div>
                        <div class="col-lg-4 pt-2">
                            <input type="text" name="pg_code" id="pg_code" class="form-control" placeholder="Rel Code">
                        </div>
                ...
                <form id="update-frm" method="post">
                    <div class="row">
                        ...
                        <input type="hidden" name="eso_id" id="eso_id">
                           ...
                           <input type="text" name="epg_description" id="epg_description" class="form-control">
                        </div>
                        <div class="col-lg-4 pt-2">
                         
                            <input type="text" name="epg_code" id="epg_code" class="form-control">
                        </div>  
       ...
       columns: [
           ...
           },
           {
               ...
               cellTemplate: function (container, options) {
                   ...
                   var SalesOrganization_description = options.data.pg_description;
                   var SalesOrganization_code = options.data.pg_code;
                   ...
                   var link = $(`<a href="javascript:void(0)" id='link_${SalesOrganization_id}' title="edit">`).html("<i class='fa fa-edit'></i> Edit")
                    ...
                    link.on("click", function () {
                        ...
                        $("#epg_description").val(SalesOrganization_description);
                        $("#eso_id").val(SalesOrganization_id);
                        $("#epg_code").val(SalesOrganization_code);    
