...
<div class="tab-content p-1">
    <div class="tab-pane active dx-viewport" id="users">
        <div class="demo-container">
          <div class="top-info">
            <div class="table-heading-custom"><h4 class="right"><i class="fas fa-building"></i> Purchase Organization List </h4></div>
            <button id="add_btn" class='custom-theme-btn'><i class='fa fa-plus'></i> Purchase Organization</button>
          </div>
    ...
    <div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Add Purchase Organization</h5>
                ...
                <form id="add-frm" method="post">
                    <div class="row">
                        <div class="col-lg-4 pt-2">
                            <input type="text" name="po_name" id="po_name" class="form-control" placeholder="Enter name">
                        </div>
                        <div class="col-lg-4 pt-2">
                            <input type="text" name="po_code" id="po_code" class="form-control" placeholder="SO Code">
                        </div>
                ...
                <form id="update-frm" method="post">
                    <div class="row">
                        ...
                        <input type="hidden" name="eso_id" id="eso_id">
                           ...
                           <input type="text" name="epo_name" id="epo_name" class="form-control">
                        </div>
                        <div class="col-lg-4 pt-2">
                         
                            <input type="text" name="epo_code" id="epo_code" class="form-control">
                        </div>  
...
$("#update-frm").validate({
    ...
    submitHandler:(r) => {
        //'next')
        var url = "{{  route('update.purchase.org') }}"
        $.ajax({
            url:url,
...
$("#add-frm").validate({
    ...
    submitHandler:(r) => {
        var url = "{{  route('add.purchase.org') }}"
        $.ajax({
            url:url,
...
function fetch_data(){
   ...
   var jsonData = new DevExpress.data.CustomStore({
       ...
       load: function (loadOptions) {
           ...
           var dataSet = []
           var url = "{{ route('get.purchase.org') }}"
           $.ajax({
               url: url,
               type: 'GET',
               headers: {
       ...
       columns: [
           ...
           },
           {
               ...
               cellTemplate: function (container, options) {
                   ...
                   var SalesOrganization_description = options.data.po_name;
                   var SalesOrganization_code = options.data.po_code;
                   ...
                   var link = $(`<a href="javascript:void(0)" id='link_${SalesOrganization_id}' title="edit">`).html("<i class='fa fa-edit'></i> Edit")
                    ...
                    link.on("click", function () {
                        ...
                        $("#epo_name").val(SalesOrganization_description);
                        $("#eso_id").val(SalesOrganization_id);
                        $("#epo_code").val(SalesOrganization_code);    
