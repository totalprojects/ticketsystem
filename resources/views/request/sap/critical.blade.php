    ...
    <div class="tab-content p-1">
        ...
        <div class="tab-pane active dx-viewport" id="request_block">
            <div class="demo-container">
                <div class="top-info">
                    <div class="table-heading-custom"><h4 class="right"><i class="fas fa-copy"></i> SAP Critical TCode Request</h4></div>
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">SAP Critical TCode Request</h5>
...
@section('js')
       ...
       //loadTcodes();
        function loadTcodes(dependencies = []){
            ...
            $.ajax({
                ...
                type:"GET",
                data:{role_id:role_id,tcode:tcode,critical:critical},
                error:(r) => {
    ...
    /** multi step form ends here */
      ...
      /** Fetch SAP Critical TCode Request */
      fetch_data();
      function fetch_data(){
   ...
   var jsonData = new DevExpress.data.CustomStore({
       ...
       load: function (loadOptions) {
           ...
           $.ajax({
               ...
               dataType: "json",
               data: '&take=' + take + '&skip=' + skip +'&critical=true',
